...
web build:
 - http://mootools.net/core/dee03d0b923084adb1bdd0e46c4d0bec

packager build:
 - packager build Core/Event Core/Slick.Finder Core/Element Core/Element.Event Core/Fx.Tween
...
},get:function(){return this.id||null;},erase:function(){this.id=this.getAttributeNode("id").value="";}};}})();(function(){Element.Properties.events={set:function(b){this.addEvents(b);
...
}};var d=function(h){var g=e[h];if(g){g.erase(this);if(!g.length&&c[h]){delete e[h];c[h]=clearInterval(c[h]);}}};})();(function(){var i=document.html;var d=document.createElement("div");
